/* CreatorDigitalPro Ebook Builder Minimal Clean - JPG Export Fixed */
...
function seedPages(){
  pages=[
    {layout:"cover",title:"Rahasia Konten Digital",content:"Panduan praktis membuat konten, membangun audiens, dan menjual produk digital dengan tampilan profesional.",cta:"Mulai Sekarang",image:"",theme:"#111827",author:"CreatorDigitalPro"},
    {layout:"chapter",title:"Mengapa Ebook Masih Menjual",content:"Ebook adalah produk digital yang mudah dibuat, mudah didistribusikan, dan bisa menjadi aset penjualan jangka panjang.",cta:"Pelajari konsepnya",image:"",theme:"#111827",author:"CreatorDigitalPro"},
    {layout:"imageTop",title:"Bangun Nilai Dari Pengetahuan",content:"Setiap pengalaman, skill, dan strategi bisa diubah menjadi materi ebook yang bermanfaat. Kuncinya adalah menyusun informasi dengan jelas dan menarik.",cta:"Tips: mulai dari masalah pembaca",image:"",theme:"#111827",author:"CreatorDigitalPro"},
    {layout:"imageSide",title:"Buat Tampilan Lebih Premium",content:"Desain visual membantu pembaca merasa produk Anda bernilai. Gunakan gambar, warna, dan struktur halaman yang rapi.",cta:"Desain menaikkan persepsi harga",image:"",theme:"#111827",author:"CreatorDigitalPro"},
    {layout:"quote",title:"Produk digital yang bagus bukan hanya berisi informasi, tetapi memberi rasa percaya kepada pembelinya.",content:"Gunakan halaman quote untuk memperkuat pesan utama ebook Anda.",cta:"",image:"",theme:"#111827",author:"CreatorDigitalPro"},
    {layout:"cta",title:"Siap Menjual Ebook Anda?",content:"Gunakan halaman CTA untuk mengarahkan pembaca membeli produk, bergabung ke komunitas, atau mengunjungi link penjualan Anda.",cta:"Kunjungi Lynk.id Anda",image:"",theme:"#111827",author:"CreatorDigitalPro"}
  ];
}
