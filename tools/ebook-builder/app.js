/* CreatorDigitalPro Ebook Builder Elite - JPG Export Fixed */
...
exportJpgBtn.addEventListener("click",async()=>{
  ...
  try{
    ...
    for(const [i,page] of ebookPages.entries()){
      exportJpgBtn.textContent=`Export JPG ${i+1}/${ebookPages.length}...`;

      /*
        FIX PENTING:
        Jangan export langsung dari preview yang sedang kena CSS responsive / transform scale di HP.
        Kita clone halaman ke area tersembunyi ukuran asli A4 supaya hasil JPG sama persis dengan preview desktop.
      */
    ...
    alert("Export JPG selesai. Semua halaman didownload satu per satu.");
  }catch(error){
...
function seedPages(){
  pages=[
    {layout:"cover",title:"Rahasia Konten Digital",content:"Panduan praktis membuat konten, membangun audiens, dan menjual produk digital dengan tampilan profesional.",cta:"Mulai Sekarang",image:"",theme:"#7c5cff",author:"CreatorDigitalPro"},
    {layout:"chapter",title:"Mengapa Ebook Masih Menjual",content:"Ebook adalah produk digital yang mudah dibuat, mudah didistribusikan, dan bisa menjadi aset penjualan jangka panjang.",cta:"Pelajari konsepnya",image:"",theme:"#7c5cff",author:"CreatorDigitalPro"},
    {layout:"imageTop",title:"Bangun Nilai Dari Pengetahuan",content:"Setiap pengalaman, skill, dan strategi bisa diubah menjadi materi ebook yang bermanfaat. Kuncinya adalah menyusun informasi dengan jelas dan menarik.",cta:"Tips: mulai dari masalah pembaca",image:"",theme:"#7c5cff",author:"CreatorDigitalPro"},
    {layout:"imageSide",title:"Buat Tampilan Lebih Premium",content:"Desain visual membantu pembaca merasa produk Anda bernilai. Gunakan gambar, warna, dan struktur halaman yang rapi.",cta:"Desain menaikkan persepsi harga",image:"",theme:"#7c5cff",author:"CreatorDigitalPro"},
    {layout:"quote",title:"Produk digital yang bagus bukan hanya berisi informasi, tetapi memberi rasa percaya kepada pembelinya.",content:"Gunakan halaman quote untuk memperkuat pesan utama ebook Anda.",cta:"",image:"",theme:"#7c5cff",author:"CreatorDigitalPro"},
    {layout:"cta",title:"Siap Menjual Ebook Anda?",content:"Gunakan halaman CTA untuk mengarahkan pembaca membeli produk, bergabung ke komunitas, atau mengunjungi link penjualan Anda.",cta:"Kunjungi Lynk.id Anda",image:"",theme:"#7c5cff",author:"CreatorDigitalPro"}
  ];
}
